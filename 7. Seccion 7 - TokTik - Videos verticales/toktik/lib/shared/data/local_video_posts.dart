// NOTA: En este archivo voy a colocar toda la información de mis video posts, dentro de este archivo
//       voy a tener información local pero fácilmente esto podría venir de una API, una API externa
//       como hicimos en la aplicación anterior (YesNoApp)
