...
class Stock extends FormzInput<int, StockError> {
  ...
  StockError? validator(int value) {
    ...
    // NOTA: El tryParse intenta parsear el valor y si no lo logra manda un valor por defecto que en este caso lo definimos como un -1
    //       que luego usamos para validar y lanzar una excepción.
